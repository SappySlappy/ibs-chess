    ...
    protected void createList(Board board) {
        ...
        if (this.row + 2 < 8 && this.col + 1 < 8) {
            ...
            if (destinationField == null || destinationField.getTeamNumber() != this.getTeamNumber()) {
                this.getPossibleMoves().add(new Move(this.row, this.col, this.row + 2, this.col + 1, false, null, 0));
            }
        }
        ...
        if (this.row + 1 < 8 && this.col + 2 < 8) {
            ...
            if (destinationField == null || destinationField.getTeamNumber() != this.getTeamNumber()) {
                this.getPossibleMoves().add(new Move(this.row, this.col, this.row + 1, this.col + 2, false, null, 0));
            }
        }
